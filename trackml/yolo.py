...
def read_video_2fps(model):
    ...
    while True:
        ...
        if ret:
            results = model(frame)
            # add the detection to frame 
            cv2.putText(frame, str(results), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36,255,12), 2)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_yol', type=str, default='yolo', help='source from where to take yolo') 
